    ...
    return (
      <div>
        ...
        <div className="Detailcard">
          <Overlay
            img={`${this.state.objectdetail.thumbnail?.path}.${this.state.objectdetail.thumbnail?.extension}`}
          />
          <div className="Detailcard-content">
            ...
            <div className="Detailcard-text">
              ...
              <div className="Detailcard-text-flex2">
                <Title1
                  title="Published:"
                  subtitle={this.state.objectdetail.modified}
                />
              </div>
              ...
              <Link to="/#">
                <span className="Detailcard-text-button">
                  See Variant Covers
                </span>
              </Link>
            </div>
