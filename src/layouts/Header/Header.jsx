      ...
      <>
        <header className="header" data-testid={"header"}>
            ...
            <div className="upperContainer">
              <div className="user-menu-tab">
                ...
                <div
                  ...
                  data-testid={"user-menu-links"}
                >
                  <a href="/#" className="user-menu__sign-in">
                    Sign in
                  </a>
                  <span>|</span>
                  <a href="/#" className="user-menu__join">
                    Join
                  </a>
                </div>
              </div>
              <div className="menu-icon" onClick={() => this.ClickMenu()}>
              ...
              <div className="right-links">
                <div className="searchPromo-Container">
                  ...
                  <div
                    className="searchPromo__wrap"
                    data-testid={"searchPromowrap"}
          ...
          <div className="header__lower">
            <ul>
              <li className="close-icon" onClick={() => this.CloseMenu()}>
              ...
              <li>
                <a href="/comics" data-tesid={"comics-link"}>
                  COMICS
                </a>
              </li>
              <li>
